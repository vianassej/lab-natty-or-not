...
2. Usei PartyRock para simular cenários de mercado e narrativas alternativas.
3. Produzi imagens e textos que parecessem escritos por um humano do futuro.
4. Modelei o projeto como uma plataforma interativa de storytelling.
5. Estruturei o conteúdo como um MVP com templates narrativos e cenários consistentes.

## 🚀 Resultados
* Diário com múltiplas entradas, cada uma com texto, imagem e contexto estratégico.
